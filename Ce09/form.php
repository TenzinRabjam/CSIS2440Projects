<html>   
        ...
        <script type="text/javascript">
            ...
            function validate()
            {
                ...
                if (!expression.test(document.myForm.EMail.value)) {
                    alert("you need to enter a valid email, format name@server.com.Using test");
                    document.myForm.EMail.focus();
                    //errorArray.push("You need the right format for your email")
                    return false;
                }
                if (!document.myForm.EMail.value.match(expression)) {
                    alert("You need to enter a valid email, format name@sever.com. Using Match");
                    document.myForm.EMail.focus();
                    return false;
                }
                return(true);
    ...
    <body>
        <form action="test.cgi" name="myForm" onsubmit="return(validate());">
